-- Миграция 003: Финальная миграция существующих данных проектов в рёбрах
-- Дата: 2025-10-26
            ...
            LOOP
                ...
                EXCEPTION WHEN OTHERS THEN
                    RAISE WARNING 'Ошибка при добавлении проекта % к ребру %: %', 
                        project_key, edge_id_bigint, SQLERRM;
                END;
            END LOOP;
        END IF;
    END LOOP;
