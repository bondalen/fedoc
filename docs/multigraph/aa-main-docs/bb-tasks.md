...
- **1.3.2** Настроить единый формат логирования, обработку ошибок и шаблоны ответов.  
  **Ссылки на выполнение:** *(нет)*
- **1.3.B** Сформировать backlog интеграционных сценариев: WebSocket hub (handshake, распространение событий, деградация канала), MCP Bridge (команды выборки графа, синхронизация с MCP-сервером), негативные кейсы (нет соединения, повторное подключение).  
  **Ссылки на выполнение:** *(нет)*
